...
- (void)viewDidLoad {
    ...
    SCWStewardViewController *SCWStewardVC =[[SCWStewardViewController alloc]init];
    ...
    SCWOptionCarViewController *SCWOptionCarVC =[[SCWOptionCarViewController alloc]init];
    ...
    SCWPersonalViewController *SCWPersonalVC =[[SCWPersonalViewController alloc]init];
