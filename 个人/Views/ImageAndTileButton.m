...
-(CGFloat)titleHeight
{
    return self.ImgHeight/IMAGEmultipleTITLE;
}
    ...
    if (self.buttomImageType >= ImageAndTileButtonTypeImageTop) {
        switch (self.buttomImageType) {
            case ImageAndTileButtonTypeImageTop:
            {
                ...
                CGFloat imgCenterY = _haveTitle?self.height / 2 - (SEPARETE_HEIGHT + self.titleHeight)/2:self.height / 2;
    ...
    if (self.buttomImageType) {
        switch (self.buttomImageType) {
            case ImageAndTileButtonTypeImageTop:
            {
                ...
                CGFloat titleCenterY = _haveImage?self.height / 2 + (SEPARETE_HEIGHT + self.ImgHeight)/2:self.height / 2;
